...
A modern "Enigma" for OpenPGP/LibrePGP. It makes encryption, signing, and key
management easier and more trustworthy in everyday privacy workflows.

![Enigma](https://image.cdn.bktus.com/i/2025/11/13/cc756d2a0b5ca4185535ffae5739549306338aad-1.webp)

"_[Enigma (crittografia) - Museo scienza e tecnologia Milano](https://commons.wikimedia.org/wiki/File:Enigma_(crittografia)_-\_Museo_scienza_e_tecnologia_Milano.jpg)_" by Alessandro Nassiri, available on [Wikimedia Commons](https://commons.wikimedia.org/), used under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

## The Philosophy

Most encryption tools are built for servers; GpgFrontend is crafted for humans.
Inspired by the precision of the mechanical Enigma, we believe a "Cipher
Machine" should be:

- **Predictable**: No background syncing, no silent telemetry. You press the
  key, the math executes. Nothing more, nothing less.
- **Standalone**: A machine in your pocket. Carry your keys on a USB
  drive, execute your tasks, and leave absolutely zero trace.
- **Enduring**: Built for decades, not just the next update. A steadfast
  architecture ensuring your secrets remain reliably accessible, for today,
