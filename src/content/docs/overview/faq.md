...
- For more detailed guidance, refer to the quick start manual available at [Getting Started Guide](getting-started.md).
...
on GitHub; see the [Contact](contact.md) section for details.
