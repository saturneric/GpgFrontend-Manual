...
including both public and private keys between devices. This enables users to
maintain their cryptographic identities across platforms. Starting from version
2.1.9, KeyPackage functionality has been significantly enhanced to improve
security, encryption strength, and user control.
