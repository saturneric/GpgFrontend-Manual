...
description: "Create and publish OpenPGP revocation certificates in GpgFrontend to mark a compromised or unused key as no longer trustworthy."
sidebar:
...
with the certificate) to mark a public key as revoked which means the key is no
...
Since v2.2.2 there is a shortcut: right-click the key in the **Manage Keys**
window and choose **Generate Revocation Certificate...**. That takes you
straight to step 3 below.

The longer route through the key's own window still works, and is described
here in full.
...
[img-1]: https://image.cdn.bktus.com/i/2025/07/06/8698a865162985cacd7d38b218226888fac27b9a.webp
[img-2]: https://image.cdn.bktus.com/i/2025/07/06/84bbe89bf023c2855e19e96d63a85f2f08c94006.webp
[img-3]: https://image.cdn.bktus.com/i/2025/07/06/a287f7d66fe6850fca4031502d448b7524886099.webp
